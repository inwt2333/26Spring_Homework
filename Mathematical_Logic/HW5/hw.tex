...
1.
\begin{align*}
(\lnot p \land \lnot q) \to \lnot r &\leftrightarrow \lnot(\lnot p \land \lnot q) \lor \lnot r \\
&\leftrightarrow (p \lor q) \lor \lnot r \quad\text{(De.Morgan律)}\\
&\leftrightarrow r \to (p \lor q)\\
&\leftrightarrow r \to (q \lor p)
\end{align*}
2.
\begin{align*}
\lnot(\lnot p \lor q) \lor r &\leftrightarrow (\lnot p \lor q) \to r \\
&\leftrightarrow (p \to q) \to r
\end{align*}
\end{solution}
