...
\[P = M_0(3) \times 4\pi R^2 \approx 2.32 \times 10^9 \text{ W}\]
\end{solution}
...
其中$a_0 = 0.0529 \text{ nm}$，$v_0 = 2.19 \times 10^6 \text{ m/s}$是基态电子速度，$Z$是核电荷数。代入数值，我们得到：
\begin{itemize}
    \item H ($Z=1$): $r_1=0.0529 \text{ nm}, r_2=0.2116 \text{ nm}$; $v_1=2.19 \times 10^6 \text{ m/s}, v_2=1.095 \times 10^6 \text{ m/s}$
    \item He$^+$ ($Z=2$): $r_1=0.0265 \text{ nm}, r_2=0.1058 \text{ nm}$; $v_1=4.38 \times 10^6 \text{ m/s}, v_2=2.19 \times 10^6 \text{ m/s}$
    \item Li$^{2+}$ ($Z=3$): $r_1=0.0176 \text{ nm}, r_2=0.0705 \text{ nm}$; $v_1=6.57 \times 10^6 \text{ m/s}, v_2=3.285 \times 10^6 \text{ m/s}$
\end{itemize}
...
由动量守恒得碰撞后共同速度 $V = \frac{m}{m+m}v_0=\frac{1}{2}v_0$。
...
\[ v_0 = \sqrt{\frac{2 \Delta E (m+m)}{m \cdot m}} \approx \sqrt{\frac{4 \Delta E}{m}} \]


取 $\Delta E = 10.2 \text{ eV} = 1.63 \times 10^{-18} \text{ J}$，$m = 1.67 \times 10^{-27} \text{ kg}$：
\[ v_0 = \sqrt{\frac{4 \times 1.63 \times 10^{-18}}{1.67 \times 10^{-27}}} \approx 6.25 \times 10^4 \text{ m/s} \]
\end{solution}
\end{document}